...
const UpdateOrder = () => {
    ...
    // if any one of above is loading need to show spinner
    // console.log(order)
   ...
   return (
    ...
    {loading?(<LoadingContent />):(<div className='order-container'>
        ...
        <div className='order-details'>
            ...
            <p><strong>Contact: </strong>{shippingInfo.phoneNumber}</p>
